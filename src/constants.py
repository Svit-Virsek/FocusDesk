...
preset = pygame.image.load("assets/images/preset.png")
preset = pygame.transform.scale(preset, (35, 35))
preset_rect = preset.get_rect(bottomright=(WIDTH-30, HEIGHT-180))
...
info_preset = FONT_SMALL.render("Info: Add a timer from a preset.", True, GREY)